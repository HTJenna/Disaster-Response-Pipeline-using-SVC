...
def load_data(messages_filepath, categories_filepath):
    ...
    Args:
    messages_filepath (str): Filepath for the disaster_messages dataset.
    categories_filepath (str): Filepath for the disaster_categories dataset.

    Returns:
    DataFrame: Merged dataset containing disater_messages and disaster_categories.
    """
...
def save_data(df, database_filename):
    """
    Split the categories column into separate category columns, convert values to binary, 
    ...
    Returns:
    DataFrame: Cleaned DataFrame with separate category columns and with the duplicates removed.
